#!/usr/bin/env python3
"""Script to setup cookies.json file on Render server."""
import json
import os
...
def setup_cookies():
    """Create cookies.json file in /app/data directory."""
    ...
    if cookies_file.exists():
        print(f"Cookies file already exists at {cookies_file}")
        return True
    ...
    try:
        ...
        print(f"✅ Cookies file created successfully!")
